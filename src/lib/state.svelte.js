...
export const app = $state({
  ...
  sel: { dump: null, import: null, cloneSrc: null, cloneDst: null, cmpSrc: null, cmpDst: null, browse: null, sql: null },
...
export async function loadConnections() {
  ...
  for (const k of ["dump", "import", "cloneSrc", "cloneDst", "cmpSrc", "cmpDst", "browse", "sql"]) {
